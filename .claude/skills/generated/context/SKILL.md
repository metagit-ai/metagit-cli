---
name: context
description: "Skill for the Context area of metagit-cli. 107 symbols across 19 files."
---

# Context

107 symbols | 19 files | Cohesion: 85%
...
| `list` | Function | `src/metagit/core/context/objective_service.py` | 42 |
| `upsert` | Function | `src/metagit/core/context/objective_service.py` | 54 |
...
| `build_many` | Function | `src/metagit/core/context/repo_card_service.py` | 74 |
...
| `get` | Function | `src/metagit/core/context/objective_service.py` | 46 |
| `complete` | Function | `src/metagit/core/context/objective_service.py` | 139 |
| `cancel` | Function | `src/metagit/core/context/objective_service.py` | 143 |
