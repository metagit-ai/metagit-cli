---
name: scripts
description: "Skill for the Scripts area of metagit-cli. 30 symbols across 5 files."
---
...
| File | Symbols |
|------|---------|
| `scripts/prepush-gate.py` | run_step, resolve_manifest_fixture_cmd, resolve_changelog_check_cmd, resolve_pytest_cmd, _git_lines (+4) |
