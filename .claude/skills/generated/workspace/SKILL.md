---
name: workspace
description: "Skill for the Workspace area of metagit-cli. 77 symbols across 21 files."
---

# Workspace

77 symbols | 21 files | Cohesion: 82%
...
| `workspace_repo_add` | Function | `src/metagit/cli/commands/workspace.py` | 360 |
| `test_list_projects_and_repos` | Function | `tests/core/workspace/test_catalog_service.py` | 25 |
| `list_workspace` | Function | `src/metagit/core/workspace/catalog_service.py` | 83 |
| `list_projects` | Function | `src/metagit/core/workspace/catalog_service.py` | 109 |
| `list_repos` | Function | `src/metagit/core/workspace/catalog_service.py` | 137 |
