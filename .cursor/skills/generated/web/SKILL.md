...
- **`do_GET`** (Function) — `src/metagit/core/web/server.py:77`
- **`do_PATCH`** (Function) — `src/metagit/core/web/server.py:80`
...
| `do_GET` | Function | `src/metagit/core/web/server.py` | 77 |
| `do_PATCH` | Function | `src/metagit/core/web/server.py` | 80 |
| `do_POST` | Function | `src/metagit/core/web/server.py` | 83 |
| `do_DELETE` | Function | `src/metagit/core/web/server.py` | 86 |
