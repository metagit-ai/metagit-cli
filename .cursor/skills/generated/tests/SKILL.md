...
| `tests/test_workspace_index_service.py` | test_build_index_synced_git_repo_with_tags_and_paths, test_build_index_url_only_repo_uses_project_mount_path, test_build_index_missing_path_is_configured_missing |
| `src/metagit/core/mcp/services/workspace_index.py` | build_index, _resolve_repo_path |
...
| `test_build_index_url_only_repo_uses_project_mount_path` | Function | `tests/test_workspace_index_service.py` | 55 |
| `test_build_index_missing_path_is_configured_missing` | Function | `tests/test_workspace_index_service.py` | 91 |
| `test_workspace_index_resolves_repo_paths` | Function | `tests/core/mcp/services/test_workspace_index.py` | 11 |
| `build_index` | Function | `src/metagit/core/mcp/services/workspace_index.py` | 16 |
...
| `test_list_unmanaged_sync_directories_excludes_managed` | Function | `tests/test_project_manager_prune.py` | 42 |
