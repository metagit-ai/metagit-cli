...
| `capability_compilation` | Compile request-class and topology into a task-scoped capability envelope | yes | yes | — | yes | — | [capabilities.md](capabilities.md) |
| `context_switch` | Full agent context switch with pack, prompt, objective, and env exports | yes | yes | — | yes | yes | [context-switch.md](context-switch.md) |
| `context_resume_status_tracking` | Resume candidate selection and pause/note capture ergonomics for objective status flow | yes | yes | — | yes | yes | [context-switch.md](context-switch.md) |
