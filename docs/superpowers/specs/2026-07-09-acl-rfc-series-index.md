...
Each **design** includes: Summary, Goals, Non-Goals, Architecture, Interfaces, Persistence, Events, Acceptance, Dependencies, Open questions.

Each **plan** includes: Goal, Architecture, Tech stack, Out of scope, file map, ordered phases with checkboxes. RFC-0008 adds bite-sized steps for early phases.
