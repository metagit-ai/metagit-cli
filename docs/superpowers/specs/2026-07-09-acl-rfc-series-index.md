...
| 0013 | Agent Operating System (composition) | [design](2026-07-09-rfc-0013-aos-composition-design.md) | [plan](../plans/2026-07-09-rfc-0013-aos-composition.md) | phased (TDD) | Plan expanded (ready to implement) |

## Next MR

**RFC-0013 Agent Operating System (composition)** on branch `feat/rfc-0013-aos` (worktree `.worktrees/rfc-0013`). Composition-only façade over shipped 0007–0012; no new engines. Plan: [2026-07-09-rfc-0013-aos-composition.md](../plans/2026-07-09-rfc-0013-aos-composition.md).

RFC-0012 implemented on `feat/rfc-0012-agent-scheduler` (worktree `.worktrees/rfc-0012`). RFC-0010 + RFC-0011 shipped on `main` via PR #62 (GitNexus import for RFC-0010 Task 9 remains deferred/optional).
