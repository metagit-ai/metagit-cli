...
2. **Coordination state** — local `.metagit/` JSON, optionally shared via HTTP (`RemoteHttpBackend` → `metagit web serve`) or cloud DocumentStore backends. See [sharing-state.md](../../reference/sharing-state.md) and [central-state-plane.md](../../reference/central-state-plane.md).
...
|-----|-------|--------|------|--------|
| 0015 | Central State Plane | [design](2026-07-31-rfc-0015-central-state-plane-design.md) | [plan](../plans/2026-07-31-rfc-0015-central-state-plane.md) | **Implemented** (Tasks 1–11; local/http cutover via `coord_bundle`; [ACL migration design-only](2026-07-31-rfc-0015-acl-namespace-migration.md)) |
