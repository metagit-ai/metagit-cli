...
def create_large_dataset():
    ...
    languages = [
        ...
        "Scheme", "Racket", "Common Lisp", "Assembly", "C", "Objective-C", "Pascal",
        "Fortran", "COBOL", "Ada", "Prolog", "SQL", "HTML", "CSS", "XML", "JSON"
    ]
    
    # Frameworks and libraries
    frameworks = [
        "React", "Vue", "Angular", "Svelte", "Node.js", "Express", "FastAPI", 
        "Django", "Flask", "Spring", "Laravel", "Rails", "ASP.NET", "Gin",
        "Echo", "Fiber", "Actix", "Phoenix", "Sinatra", "Koa", "Nest.js",
        "Next.js", "Nuxt.js", "Gatsby", "SvelteKit", "Remix", "Astro",
    ...
    tools = [
        ...
        "CircleCI", "Travis CI", "GitHub Actions", "AWS", "Azure", "GCP",
        "Terraform", "Ansible", "Chef", "Puppet", "Vagrant", "VirtualBox",
        "VMware", "Redis", "MongoDB", "PostgreSQL", "MySQL", "SQLite",
        "Elasticsearch", "Apache", "Nginx", "Prometheus", "Grafana", "Kibana"
    ]
...
def test_preview_with_scrolling():
    ...
    tech_items = [
        TechItem("Python", "A high-level programming language known for its simplicity and versatility. Great for web development, data science, AI, and automation."),
        TechItem("JavaScript", "The programming language of the web. Used for both frontend and backend development with Node.js."),
        TechItem("React", "A popular JavaScript library for building user interfaces, especially single-page applications."),
        TechItem("Docker", "A containerization platform that makes it easy to package and deploy applications."),
        TechItem("Kubernetes", "An orchestration platform for managing containerized applications at scale."),
        TechItem("PostgreSQL", "A powerful, open-source relational database system with advanced features."),
        TechItem("Redis", "An in-memory data structure store used as a database, cache, and message broker."),
        TechItem("FastAPI", "A modern, fast web framework for building APIs with Python 3.7+ and type hints."),
        TechItem("Vue.js", "A progressive JavaScript framework for building user interfaces and single-page applications."),
        TechItem("Go", "A programming language developed by Google, known for its simplicity and performance."),
    ]
