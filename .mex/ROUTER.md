...
- **ACL RFC series (0008–0013):** designs + plans under `docs/superpowers/` — index [docs/superpowers/specs/2026-07-09-acl-rfc-series-index.md](../docs/superpowers/specs/2026-07-09-acl-rfc-series-index.md). Series composition complete on `feat/rfc-0013-aos` (pending merge). Root `spec.md` retired; vision lives in agent-coordination + series index.
