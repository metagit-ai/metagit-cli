...
**Working:**
- **RFC-0007 ACL foundation:** `metagit branch|lease|worktree|claim` + MCP tools; persistence under `.metagit/{branches,leases,worktrees,claims,agents,events}/`; isolated `.worktrees/`; advisory claims; ACL events in context feed; docs `docs/reference/agent-coordination.md`. Deferred: task graph / merge orchestrator / scheduler (RFC-0008+).
