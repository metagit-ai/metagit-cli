...
**Working:**
- **RFC-0008 Task Graph & Intent + RFC-0009 Context Compiler (in progress on `feat/rfc-0008-task-graph`):** `metagit task` + MCP `metagit_task_*`; `metagit context compile` + MCP `metagit_context_compile`; packages `metagit.core.taskgraph` / `metagit.core.context.compiler`; docs `task-graph.md` / `context-compiler.md`; modality `task_graph` / `context_compile`. Next after ship: RFC-0010 or 0011.
