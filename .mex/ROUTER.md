...
- **ACL RFC series (0008–0013) build specs drafted:** designs + plans under `docs/superpowers/` — index [docs/superpowers/specs/2026-07-09-acl-rfc-series-index.md](../docs/superpowers/specs/2026-07-09-acl-rfc-series-index.md). Next implementable MR: RFC-0008 Task Graph & Intent. 0009–0013 phased; 0013 is composition-only (no new engines). Root `spec.md` retired; vision lives in agent-coordination + series index.
