...
- **RFC-0010 + RFC-0011 (in progress on `feat/rfc-0010-0011`):** Semantic KG plan expanded (TDD); Task 1 foundation (`metagit.core.semantic` models, paths, JSON store) implemented; merge orchestrator follows on same branch. Worktree `.worktrees/rfc-0010-0011`.
