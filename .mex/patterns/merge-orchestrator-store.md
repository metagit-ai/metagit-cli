...
description: Implementing or extending RFC-0011 merge orchestrator models, paths, JSON store, and events.
triggers:
  - "merge orchestrator"
  - "RFC-0011"
  - "MergeStore"
...
2. Keep persistence in `MergeStore`; defer git operations, services, CLI, MCP,
   and event writers unless the task explicitly opens those layers.
...
## Gotchas
- Do not implement `git_ops`, service orchestration, or CLI while doing Task 1.
